...
/// <summary>
/// Event dispatched when a <see cref="HealthSystem"/> takes damage.
/// </summary>
...
/// <summary>
/// Event dispatched on a root object containing a <see cref="HealthSystem"/> that took damage.
/// </summary>
/// <param name="Damage">Information about the damage.</param>
public record DamageTakenEvent( DamageInfo DamageInfo ) : IGameEvent;

/// <summary>
/// Event dispatched to everything when a <see cref="HealthSystem"/> takes damage.
/// </summary>
...
/// <summary>
/// Event dispatched in the scene when a <see cref="HealthSystem"/> died after taking damage.
/// </summary>
