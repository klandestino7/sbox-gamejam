...
public partial class Player
{
	...
	private void OnUpdateMovement()
	{
		...
		{
			PlayerBody.Transform.Rotation = Rotation.FromYaw( EyeAngles.yaw );
		}
		...
		if ( AnimationHelper.IsValid() )
		{
			...
			AnimationHelper.Handedness = AnimationHelper.Hand.Both; // 
    ...
    private bool WantsToSprint => Input.Down( "Run" ) && !IsSlowWalking &&  WishMove.x > 0.2f; // !HasEquipmentTag( "no_sprint" ) &&
	...
	private void BuildInput()
	{
		...
		// if ( Input.Pressed( "Noclip" ) && Sandbox.Game.IsEditor )
		// {
